...
func main() {
	configPath := flag.String("config", "configs/polling-place.yaml", "path to votechain machine config")
	flag.Parse()
	...
	go func() {
		logger.Info("votechain machine listening", slog.String("addr", cfg.Server.Listen))
